...
Portanto, o objetivo principal do nosso trabalho é investigar o impacto do desmatamento da Amazônia Legal no aumento de zoonoses nos últimos x anos e relacionar surgimento e surtos de zoonoses com os índices de desmatamento. Adicionalmente, pretendemos caracterizar os tipos de zoonoses mais relevantes que atingiram a região amazônica, a fim de identificar um padrão é possível predição e tendências de novos surtos.
